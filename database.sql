...
-- Dumping data for `auth_user` (5 records)
...
(4, 'pbkdf2_sha256$1000000$KVcyAeckDbqfMaVouC4v1B$YwISUF5SNY4r3HldmIIHkkDoyZ2xKd01I+UQexYndMk=', NULL, 0, 'vaidy', '', '', 'vaidy@gmail.com', 0, 1, '2026-07-21 16:28:56'),
(5, 'pbkdf2_sha256$1000000$GgpvveArGixmMIdxAaWCWc$ZwbnOLk4ZWTzKktyYck1VseuCB2sRjr/WDkUO+3TaSI=', NULL, 0, 'luxury_buyer', '', '', 'buyer@veloce.in', 0, 1, '2026-07-21 16:45:58');
...
(4, 'Audi', 'RS 7 Sportback', 'Sedan', '22400000.00', 9, 2024, 'https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?auto=format&fit=crop&w=800&q=80', '2026-07-21 16:13:10', '2026-07-21 16:31:17', 'Aggressive fastback design powered by a 591 hp 4.0L twin-turbo V8 with quattro AWD.'),
...
(13, 'Rolls-Royce', 'Ghost Black Badge', 'Sedan', '69500000.00', 0, 2024, 'https://images.unsplash.com/photo-1631295868223-63265b40d9e4?auto=format&fit=crop&w=800&q=80', '2026-07-21 16:13:10', '2026-07-21 16:29:30', 'The pinnacle of bespoke luxury with Starlight Headliner and 6.75L twin-turbo V12 engine.'),
...
(25, 'Porsche', 'Taycan Turbo S', 'Sedan', '24400000.00', 1, 2024, 'https://images.unsplash.com/photo-1614162692292-7ac56d7f7f1e?auto=format&fit=crop&w=800&q=80', '2026-07-21 16:13:10', '2026-07-21 16:30:53', '750 hp overboost electric sports sedan accelerating 0-100 km/h in 2.8 seconds.'),
...
(29, 'Alfa Romeo', 'Giulia Quadrifoglio', 'Sedan', '12800000.00', 0, 2024, 'https://images.unsplash.com/photo-1542282088-72c9c27ed0cd?auto=format&fit=crop&w=800&q=80', '2026-07-21 16:13:10', '2026-07-22 03:59:38', 'Ferrari-derived 2.9L Twin-Turbo V6 generating 505 hp with carbon-fiber active front splitter.'),
