...
export default function PurchaseModal({ vehicle, onClose, onSuccess }) {
  ...
  const estimatedTax = basePrice * 0.07
  const docFee = 495
  const totalPrice = basePrice + estimatedTax + docFee
          ...
          <div>
            ...
            <div className="bg-slate-900/90 rounded-2xl p-4 border border-slate-800 mb-6 flex items-center justify-between">
              ...
              <div className="text-right">
                <div className="text-xs text-slate-500 font-semibold uppercase">MSRP</div>
            ...
            <div className="space-y-3 text-sm border-t border-b border-slate-800/80 py-4 mb-6">
              ...
              <div className="flex justify-between text-slate-400">
                <span>Dealership Documentation Fee</span>
                <span className="font-semibold text-slate-200">{formatPrice(docFee)}</span>
              </div>
