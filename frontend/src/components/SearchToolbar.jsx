...
export default function SearchToolbar({
  ...
  return (
    <div className="steel-card rounded-2xl p-6 mb-8 space-y-4">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-xl bg-[#E63946]/10 border border-[#E63946]/30 flex items-center justify-center text-[#E63946]">
            <Filter className="w-4 h-4" />
          </div>
          <div>
            <h2 className="font-heading text-lg font-bold text-white">Filter Inventory</h2>
            <p className="text-xs text-[#94A3B8]">Refine search by make, model, category, or price in ₹</p>
          </div>
        </div>

        <button
          onClick={onReset}
          className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#171A21] border border-white/[0.08] text-[#94A3B8] hover:text-white text-xs font-semibold transition-all self-end md:self-auto"
        >
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[#171A21] border border-white/[0.08] rounded-xl pl-10 pr-3.5 py-2.5 text-xs text-[#F8FAFC] placeholder-[#94A3B8] focus:outline-none focus:border-[#E63946] transition-all"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full bg-[#171A21] border border-white/[0.08] rounded-xl pl-10 pr-3.5 py-2.5 text-xs text-[#F8FAFC] focus:outline-none focus:border-[#E63946] transition-all appearance-none"
            >
