        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-12 md:w-1/2 lg:w-[45%] bg-[#0B0F14]">
          <div className="max-w-md w-full bg-[#141A22] border border-white/[0.08] rounded-2xl p-8 sm:p-10 shadow-2xl relative z-10">
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <p className="text-[#94A3B8] text-xs mt-2">Access your AutoVault reserve account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block text-[10px] font-bold uppercase tracking-widest text-[#94A3B8] mb-2">Username</label>
              ...
              <div>
                <label className="block text-[10px] font-bold uppercase tracking-widest text-[#94A3B8] mb-2">Password</label>
                <div className="relative">
